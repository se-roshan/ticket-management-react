      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-3 text-center text-md-end">
            <h6 className="fw-bold text-dark">Connect with us</h6>
            <div className="d-flex justify-content-center justify-content-md-end gap-3">
              {/* Facebook */}
              <a href="#" className="text-dark">
                <svg width="24" height="24" viewBox="0 0 8 19" fill="currentColor">
                  <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd"/>
                </svg>
              </a>
              {/* Twitter */}
              <a href="#" className="text-dark">
                <svg width="24" height="24" viewBox="0 0 20 17" fill="currentColor">
        ...
        <div className="text-center mt-3">
          <small className="text-muted">
            © 2025 <a href="#" className="text-decoration-none">Ticket Management</a>. All Rights Reserved.
          </small>
        </div>
      </div>
    </footer>
